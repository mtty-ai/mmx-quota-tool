window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    var CSS = [
      ...
      "  width:max-content; max-width:min(320px, 92vw); min-width:240px;",
      ...
      "  font-weight:500; color:var(--dsw-alias-label-primary, #1f2328);",
      "  font-size:12px; white-space:nowrap; min-width:0; max-width:140px;",
      "  overflow:hidden; text-overflow:ellipsis;",
      "}",
      ".dsh-mmx-quota-dock__panel .row-stats { display:flex; flex-direction:column; gap:6px; min-width:0; }",
      ".dsh-mmx-quota-dock__panel .stat { display:grid;",
      "  grid-template-columns: 20px minmax(20px, 1fr) 30px;",
      ...
      ".dsh-mmx-quota-dock__panel .row-resets { display:flex; flex-direction:column; gap:6px; min-width:36px; }",
    ...
    function RowDetails(props) {
      ...
      return React.createElement("div", { className: "row" },
        ...
        React.createElement("div", { className: "row-resets" },
          React.createElement("div", { className: "stat-reset" }, reset5h ? reset5h + " " + s.resetSuffix : s.resetNever),
          React.createElement("div", { className: "stat-reset" }, resetWeek ? resetWeek + " " + s.resetSuffix : s.resetNever),
        ),
      )
    }
