window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    var CSS = [
      ...
      "  font-weight:500; color:var(--dsw-alias-label-primary, #1f2328);",
      "  font-size:12px; white-space:nowrap; flex:0 1 auto; min-width:0; max-width:140px;",
      "  overflow:hidden; text-overflow:ellipsis;",
      "}",
      ".dsh-mmx-quota-dock__panel .row-stats { display:flex; flex-direction:column; gap:6px; flex-shrink:0; min-width:0; margin-left:auto; }",
