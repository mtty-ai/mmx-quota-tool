window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    var CSS = [
      ...
      "}",
      ".dsh-mmx-quota-dock__panel-list { margin:10px 0 0; border-collapse:collapse; width:max-content; table-layout:auto; }",
      ".dsh-mmx-quota-dock__panel .row-name {",
      "  font-weight:500; color:var(--dsw-alias-label-primary, #1f2328);",
      "  font-size:12px; white-space:nowrap; max-width:140px;",
      "  overflow:hidden; text-overflow:ellipsis; padding:2px 8px 2px 0; vertical-align:middle;",
      "}",
      ...
      "}",
      ".dsh-mmx-quota-dock__panel .bar-cell { padding:2px 0; min-width:96px; display:flex; align-items:center; gap:6px; }",
      ".dsh-mmx-quota-dock__panel .bar-cell .bar { flex:0 0 auto; width:60px; }",
      ...
      "  padding:2px 0 2px 6px; white-space:nowrap;",
      "}",
      ...
      "  text-align:right; font-size:10px; line-height:14px; padding:2px 0 2px 8px;",
      "  color:var(--dsw-alias-label-tertiary, #9ca3af); font-variant-numeric:tabular-nums;",
    ...
    function QuotaIcon(props) {
      ...
      var panel = open ? React.createElement("div", {
        ...
        React.createElement("table", { className: "dsh-mmx-quota-dock__panel-list" },
